...
EXTERNAL_AUTHORITY_LINK_TARGETS = frozenset(
    {
        ...
        "agent_runtime_02_product_target_topology.md",
        "agent_runtime_04_publication_transaction_contract.md",
        "agent_runtime_05_delivery_roadmap.md",
        ...
        "the_review_contract.md",
        "the_identifier_and_reference_semantics.md",
        "the_data_governance.md",
        "the_design_doc_management.md",
